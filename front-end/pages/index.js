  ...
  return (
    <>
      ...
      <main className=" h-screen from-gray-800 via-gray-600 to-gray-800 bg-gradient-to-r">
        ...
        <div className="flex">
          <div
            className="flex mx-auto flex-col md:w-1/2 lg:h-1/3 xl:w-1/4 p-4 mb-16 my-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
            role="alert"
          >
            <div className=" flex flex-row">
              ...
              <div className="font-medium block">Test Full Feature with:</div>
            </div>
