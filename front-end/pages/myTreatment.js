...
const MyTreatment = () => {
    ...
    return (
        <>
        <Card>
        <Header headline={`My Treatments`} subtext={'Find the treatments you were assigned below.'} />
            {patient.exercises  && (
            ...
            <tr key={index} className="">
                <th scope="row" className="">
                    <Link href={"/treatment/" + e.exercise._id}>{e.exercise.title}</Link>
                </th>
