    ...
    return (
        ...
        <div className=" border-r-2 border-blue-100/25 border-double  p-10 text-white h-screen absolute  w-full m-0 pt-5" style={{ backgroundColor: 'rgba(44, 47, 72, 0.46)' }}>
            ...
            <ul className=" mt-2 flex flex-col gap-5 ">
                ...
                <li className=" hover:bg-black hover:opacity-70 rounded duration-300 hover:cursor-pointer p-3 flex"><MdCreateNewFolder className=" text-xl  mr-2"/><Link href="/patient/favoriteTreatments">My Favorite Treatments</Link></li>
                <li className=" hover:bg-black hover:opacity-70 rounded duration-300 hover:cursor-pointer p-3 flex"><FaUserFriends className=" text-xl  mr-2"/><Link href="/patient/myTherapist">My Therapist</Link></li>
            </ul>
